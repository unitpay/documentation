...
{% hint style="warning" %}
**Внимание!** Каждый кошелек \(полный или упрощенный\) создается на уникальные паспортные данные и СНИЛС. Если вы ошиблись при создании кошелька или хотите закрыть упрощенный и открыть полный кошелек, то напишите нам в службу поддержки **manager@unitpay.money,** дублировать данные в форме идентификации не нужно.
{% endhint %}
...
О: Да, конечно, ваши средства вы в любом случае выведете.  
