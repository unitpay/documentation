...
| **currency** | строка | Валюта суммы оплаты по ISO 4217 \(RUB, UAH, BYN, EUR, USD, например, подробнее - [тут](https://help.unitpay.money/book-of-reference/bukvennye-kody-valyut). Если платежная система не поддерживает требуемую валюту, то сумма будет сконвертирована в валюту по умолчанию. |
